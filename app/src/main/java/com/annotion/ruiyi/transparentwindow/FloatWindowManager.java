...
import com.annotion.ruiyi.transparentwindow.rom.HuaweiUtils;
import com.annotion.ruiyi.transparentwindow.rom.MeizuUtils;
import com.annotion.ruiyi.transparentwindow.rom.MiuiUtils;
import com.annotion.ruiyi.transparentwindow.rom.OppoUtils;
import com.annotion.ruiyi.transparentwindow.rom.QikuUtils;
import com.annotion.ruiyi.transparentwindow.rom.RomUtils;
...
public class FloatWindowManager {
    ...
    public void applyOrShowFloatWindow(Context context) {
        if (checkPermission(context)) {
            myWindow = MyWindow.getInstence(context);
            myWindow.openWindow();
